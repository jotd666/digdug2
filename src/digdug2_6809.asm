...
; 0: no level select, != 0 (4) level select
select_level_enabled_10f0 = $10F0
sprite_shadow_ram_1f16 = $1f16
scroll_register_3800 = $3800
scroll_value_1008 = $1008
game_in_play_101b = $101b
start_game_flag_10e9 = $10e9
current_level_bcd_1705 = $1705
current_player_1005 = $1005
nb_players_minus_one_1004 = $1004
player_directions_1012 = $1012
player_decoded_directions_1013 = $1013
...
8009: B4 10 05       ANDA   current_player_1005
800C: B7 10 07       STA    $1007
800F: 8E 50 04       LDX    #video_stuff_5004
8012: A7 86          STA    A,X
; set logical scroll value to hardware registers
; 0: title screen, 0xFF: maximum scroll to the left (revealing other
; tiles screen). No wraparound. Status bars are not affected by scrolling
8014: B6 10 08       LDA    scroll_value_1008
8017: C6 08          LDB    #$08
8019: 3D             MUL
801A: 8E 38 00       LDX    #scroll_register_3800
801D: A7 8B          STA    D,X
...
804C: EC 84          LDD    ,X
804E: ED C1          STD    ,U++	; store X and Y
...
815B: CC 10 10       LDD    #demo_on_1010
815E: 6F 80          CLR    ,X+
8160: 5A             DECB
...
8243: B6 48 16       LDA    dsw_extra_lives_select_level_4816
8246: 84 03          ANDA   #$03
8248: 48             ASLA
8249: B7 10 70       STA    $1070
824C: B6 48 16       LDA    dsw_extra_lives_select_level_4816
824F: 84 08          ANDA   #$08
8251: B7 10 EF       STA    $10EF
8254: B6 48 16       LDA    dsw_extra_lives_select_level_4816
8257: 84 04          ANDA   #$04
8259: B7 10 F0       STA    select_level_enabled_10f0
825C: BD 8F 67       JSR    create_base_tasks_8f67
825F: BD 81 50       JSR    suspend_task_8150
8262: BD 8A B2       JSR    $8AB2
8265: 4F             CLRA
8266: B7 10 05       STA    current_player_1005
...
8281: BD 8B DF       JSR    write_highscore_text_8bdf
...
82EA: C4 0F          ANDB   #$0F
82EC: 26 07          BNE    $82F5
82EE: B6 10 10       LDA    demo_on_1010
82F1: 26 ED          BNE    $82E0
82F3: 20 9A          BRA    $828F
82F5: 7F 10 10       CLR    demo_on_1010
82F8: 7F 10 E2       CLR    $10E2
82FB: 7C 10 E3       INC    $10E3
82FE: BD 87 06       JSR    clear_screen_8706
8301: BD 8B 3D       JSR    $8B3D
8304: BD 8B DF       JSR    write_highscore_text_8bdf
...
8353: 26 30          BNE    $8385
8355: 7C 10 E9       INC    start_game_flag_10e9
...
8378: 26 F8          BNE    $8372
837A: B6 10 05       LDA    current_player_1005
837D: 26 03          BNE    $8382
...
844D: 27 14          BEQ    $8463
844F: B6 10 04       LDA    nb_players_minus_one_1004
...
852C: 26 F0          BNE    $851E
852E: B6 10 05       LDA    current_player_1005
8531: 4C             INCA
8532: 84 01          ANDA   #$01
8534: B7 10 05       STA    current_player_1005
8537: 39             RTS
...
85EB: CE 86 0A       LDU    #$860A	; (c) 1982 1985 NAMCO
85EE: 86 11          LDA    #$11
85F0: BD 85 90       JSR    write_text_8590
85F3: 8E 02 F9       LDX    #$02F9
85F6: CE 86 1B       LDU    #$861B		; ALL RIGHTS RESERVED
85F9: 86 13          LDA    #$13
85FB: BD 85 90       JSR    write_text_8590
85FE: 8E 02 3C       LDX    #$023C
8601: CE 86 2E       LDU    #$862E		; namco logo
8604: 86 07          LDA    #$07
...
863B: 86 08          LDA    #$08
863D: BD 85 AE       JSR    write_status_text_85ae
...
8753: CE 87 A9       LDU    #$87A9		; game over
8756: 86 0A          LDA    #$0A
...
write_ready_player_8767:
8767: 8E 02 4C       LDX    #$024C
876A: CE 87 9E       LDU    #$879E		; ready
876D: 86 05          LDA    #$05
...
8789: CE 87 A3       LDU    #$87A3		; player
878C: 86 06          LDA    #$06
878E: BD 85 90       JSR    write_text_8590
8791: B6 10 05       LDA    current_player_1005
8794: 4C             INCA
...
87DB: 86 08          LDA    #$08
87DD: BD 85 AE       JSR    write_status_text_85ae
...
881B: B6 10 04       LDA    nb_players_minus_one_1004           
881E: 27 03          BEQ    $8823           
...
8B6E: 7D 10 04       TST    nb_players_minus_one_1004
8B71: 27 0B          BEQ    $8B7E
...
8BF9: 86 0A          LDA    #$0A
8BFB: BD 85 AE       JSR    write_status_text_85ae
; copy " H" for what?
8BFE: FC 07 D0       LDD    $07D0		; [video_address_word]
8C01: FD 07 C0       STD    $07C0		; [video_address_word
8C04: 39             RTS
...
8C8A: 44             LSRA
8C8B: A7 06          STA    $6,X
8C8D: F6 10 04       LDB    nb_players_minus_one_1004
8C90: 27 03          BEQ    $8C95
...
8C9E: 7D 10 04       TST    nb_players_minus_one_1004
8CA1: 27 03          BEQ    $8CA6
8CA3: E7 88 64       STB    $64,X
8CA6: 48             ASLA
8CA7: EC C6          LDD    A,U
8CA9: ED 88 22       STD    $22,X
8CAC: 7D 10 04       TST    nb_players_minus_one_1004
8CAF: 26 01          BNE    $8CB2
8CB1: 39             RTS
...
task_entry_03_read_joy_buttons_8fac:
8FAC: BD 81 50       JSR    suspend_task_8150
8FAF: B6 10 1B       LDA    game_in_play_101b
8FB2: 27 F8          BEQ    task_entry_03_read_joy_buttons_8fac
8FB4: B6 10 04       LDA    nb_players_minus_one_1004
8FB7: B4 10 05       ANDA   current_player_1005
8FBA: B4 10 06       ANDA   $1006
8FBD: C6 02          LDB    #$02
8FBF: 3D             MUL
8FC0: 8E 48 05       LDX    #joystick_button_1_4805
8FC3: 3A             ABX
8FC4: F6 10 15       LDB    pump_button_pressed_1015
8FC7: 58             ASLB
8FC8: A6 84          LDA    ,X
8FCA: 84 02          ANDA   #$02
8FCC: 27 01          BEQ    $8FCF
...
8FE4: 5C             INCB
8FE5: C4 03          ANDB   #$03
8FE7: F7 10 14       STB    hammer_button_pressed_1014
8FEA: 20 C0          BRA    task_entry_03_read_joy_buttons_8fac
8FEC: 84 02          ANDA   #$02
8FEE: B7 10 14       STA    hammer_button_pressed_1014
8FF1: 20 B9          BRA    task_entry_03_read_joy_buttons_8fac


task_entry_02_read_joy_directions_8ff3:
8FF3: BD 81 50       JSR    suspend_task_8150
8FF6: B6 10 1B       LDA    game_in_play_101b
8FF9: 27 F8          BEQ    task_entry_02_read_joy_directions_8ff3
; activated only when game is playing
8FFB: B6 10 04       LDA    nb_players_minus_one_1004
8FFE: B4 10 05       ANDA   current_player_1005
...
900A: A6 85          LDA    B,X
900C: 84 0F          ANDA   #$0F
900E: B7 10 12       STA    player_directions_1012
9011: 8E 90 1B       LDX    #$901B		; decode direction table
9014: E6 86          LDB    A,X
9016: F7 10 13       STB    player_decoded_directions_1013
9019: 20 D8          BRA    task_entry_02_read_joy_directions_8ff3

task_entry_01_show_current_player_902b:
...
905A: F6 10 05       LDB    current_player_1005
905D: 27 02          BEQ    $9061
905F: 1E 13          EXG    X,U
...
9067: 1E 13          EXG    X,U
9069: C8 01          EORB   #$01
906B: 7D 10 04       TST    nb_players_minus_one_1004
906E: 26 12          BNE    $9082
9070: C6 02          LDB    #$02
9072: 20 0E          BRA    $9082
...
task_entry_04_demo_task_909c:
909C: BD 81 50       JSR    suspend_task_8150
909F: B6 10 10       LDA    demo_on_1010
90A2: 27 F8          BEQ    task_entry_04_demo_task_909c
...
90FE: EC 81          LDD    ,X++
9100: B7 10 13       STA    player_decoded_directions_1013
9103: F7 10 60       STB    $1060
9106: BF 10 63       STX    $1063
9109: 8E 93 34       LDX    #$9334
910C: EC 81          LDD    ,X++
910E: B7 10 14       STA    hammer_button_pressed_1014
9111: F7 10 61       STB    $1061
9114: BF 10 65       STX    $1065
9117: 8E 93 84       LDX    #$9384
911A: EC 81          LDD    ,X++
911C: B7 10 15       STA    pump_button_pressed_1015
...
915E: B7 10 13       STA    player_decoded_directions_1013
...
9171: B7 10 14       STA    hammer_button_pressed_1014
9174: F7 10 61       STB    $1061
9177: 7A 10 62       DEC    $1062
917A: 26 C8          BNE    demo_loop_9144
917C: BE 10 67       LDX    $1067
917F: EC 81          LDD    ,X++
9181: BF 10 67       STX    $1067
9184: B7 10 15       STA    pump_button_pressed_1015
...
9A04: B6 10 13       LDA    player_decoded_directions_1013
9A07: 2B 4B          BMI    $9A54
9A09: 81 02          CMPA   #$02
9A0B: 23 0C          BLS    $9A19
9A0D: 30 1F          LEAX   -$1,X
...
9BFE: 5A             DECB
9BFF: 26 FB          BNE    $9BFC
9C01: B6 17 05       LDA    current_level_bcd_1705
...
task_entry_16_level_select_and_start_9d20:
9D20: BD 81 50       JSR    suspend_task_8150
9D23: B6 10 E9       LDA    start_game_flag_10e9
9D26: 27 F8          BEQ    task_entry_16_level_select_and_start_9d20
; game has been started
9D28: B6 10 F0       LDA    select_level_enabled_10f0
9D2B: 10 27 01 99    LBEQ   skip_level_select_9ec8
9D2F: BD 87 06       JSR    clear_screen_8706
9D32: B6 10 05       LDA    current_player_1005
9D35: 27 28          BEQ    $9D5F
...
9D6D: CE 9E F7       LDU    #$9EF7		; TIME
9D70: 86 04          LDA    #$04
9D72: BD 85 90       JSR    write_text_8590
9D75: 8E 07 AB       LDX    #$07AB
9D78: CE 88 0D       LDU    #$880D		; ROUND
9D7B: 86 08          LDA    #$08
9D7D: BD 85 AE       JSR    write_status_text_85ae
...
9DD0: FD 10 14       STD    hammer_button_pressed_1014
9DD3: 7C 10 1B       INC    game_in_play_101b
...
9E02: FC 10 14       LDD    hammer_button_pressed_1014
9E05: 26 7E          BNE    $9E85
9E07: B6 01 76       LDA    $0176
9E0A: 27 79          BEQ    $9E85
9E0C: B6 10 13       LDA    player_decoded_directions_1013
9E0F: 2B C5          BMI    $9DD6
9E11: 85 02          BITA   #$02
9E13: 27 C1          BEQ    $9DD6
9E15: 85 04          BITA   #$04
...
; clear flags
9ECB: B7 10 1B       STA    game_in_play_101b	; will be set to 1 after "ready" screen
9ECE: B7 10 E9       STA    start_game_flag_10e9	; disables this task
...
A2B3: 81 01          CMPA   #$01
A2B5: 27 B5          BEQ    $A26C
A2B7: B6 10 14       LDA    hammer_button_pressed_1014
A2BA: 26 1A          BNE    $A2D6
A2BC: B6 10 13       LDA    player_decoded_directions_1013
A2BF: 2B DF          BMI    $A2A0
...
A4F2: B6 10 15       LDA    pump_button_pressed_1015
...
A5CB: E6 05          LDB    $5,X
A5CD: 20 13          BRA    $A5E2
A5CF: F6 10 13       LDB    player_decoded_directions_1013
A5D2: 2B 2D          BMI    $A601
A5D4: E1 05          CMPB   $5,X
A5D6: 27 0A          BEQ    $A5E2
A5D8: E7 05          STB    $5,X
...
A5E2: C5 04          BITB   #$04
A5E4: 26 04          BNE    $A5EA
A5E6: A6 C4          LDA    ,U		; [video_address]
A5E8: 20 03          BRA    $A5ED
A5EA: A6 C8 21       LDA    $21,U		; [video_address]
A5ED: C5 02          BITB   #$02
A5EF: 26 06          BNE    $A5F7
A5F1: 85 01          BITA   #$01
A5F3: 26 0C          BNE    $A601
...
A75A: A7 84          STA    ,X		; [video_address]
...
B3DD: A6 81          LDA    ,X++
B3DF: E1 C6          CMPB   A,U		; [video_address]
B3E1: 23 1F          BLS    $B402
B3E3: 8B E0          ADDA   #$E0
...
B3FA: 23 06          BLS    $B402
B3FC: 8B E0          ADDA   #$E0
B3FE: E1 C6          CMPB   A,U		; [video_address]
B400: 22 08          BHI    $B40A
B402: A6 1F          LDA    -$1,X
...
B41A: A6 01          LDA    $1,X
B41C: 33 C6          LEAU   A,U
B41E: A6 C9 08 00    LDA    $0800,U	; [video_address]
B422: 81 10          CMPA   #$10
B424: 27 37          BEQ    $B45D
B426: 25 10          BCS    $B438
B428: 81 20          CMPA   #$20
...
B42C: 81 30          CMPA   #$30
B42E: 26 2D          BNE    $B45D
B430: A6 C4          LDA    ,U	; [video_address]
B432: A5 04          BITA   $4,X
B434: 26 1F          BNE    $B455
B436: 20 25          BRA    $B45D
B438: A6 C4          LDA    ,U	; [video_address]
B43A: 81 70          CMPA   #$70
B43C: 25 17          BCS    $B455
...
B447: 85 01          BITA   #$01
B449: 27 0A          BEQ    $B455
B44B: A6 C4          LDA    ,U			; [video_address]
B44D: 81 60          CMPA   #$60
B44F: 25 04          BCS    $B455
B451: A5 84          BITA   ,X
B453: 27 08          BEQ    $B45D
...
B460: 27 05          BEQ    $B467
B462: 33 C8 E0       LEAU   -$20,U	; [video_address]
B465: 20 B7          BRA    $B41E
...
B490: E6 C9 08 00    LDB    $0800,U	; [video_address]
B494: C1 30          CMPB   #$30
B496: 26 08          BNE    $B4A0
B498: E6 C4          LDB    ,U		; [video_address]
B49A: C4 03          ANDB   #$03
B49C: 26 0A          BNE    $B4A8
B49E: 20 0F          BRA    $B4AF
B4A0: C1 10          CMPB   #$10
...
B4B2: 27 0B          BEQ    $B4BF
B4B4: 33 C8 20       LEAU   $20,U			; [video_address]
B4B7: 20 D7          BRA    $B490
...
B70D: B6 10 08       LDA    scroll_value_1008
B710: 84 E0          ANDA   #$E0
B712: 44             LSRA
B713: 44             LSRA
B714: 8B 08          ADDA   #$08
...
C55C: A6 A5          LDA    B,Y
C55E: 33 C6          LEAU   A,U
C560: A6 C4          LDA    ,U		; [video_address]
C562: E6 C9 08 00    LDB    $0800,U		; [video_address]
C566: 39             RTS
...
C855: E6 C0          LDB    ,U+
C857: 3A             ABX
C858: A6 84          LDA    ,X		; [video_address]
C85A: 2B 3C          BMI    $C898
C85C: E6 89 08 00    LDB    $0800,X		; [video_address]
C860: C1 30          CMPB   #$30
C862: 26 07          BNE    $C86B
C864: BB 10 3C       ADDA   $103C
C867: A7 84          STA    ,X		; [video_address]
C869: 20 49          BRA    $C8B4
C86B: C1 1F          CMPB   #$1F
C86D: 23 1B          BLS    $C88A
C86F: C5 04          BITB   #$04
...
C88D: A7 84          STA    ,X		; [video_address]
C88F: FA 10 40       ORB    $1040
C892: E7 89 08 00    STB    $0800,X		; [video_address]
C896: 20 1C          BRA    $C8B4
...
C8AD: E7 89 08 00    STB    $0800,X		; [video_address]
...
C959: 24 19          BCC    $C974
C95B: 86 70          LDA    #$70
C95D: A1 C8 E0       CMPA   -$20,U		; [video_address]
C960: 23 12          BLS    $C974
C962: F6 10 09       LDB    $1009
C965: 26 09          BNE    $C970
C967: A1 41          CMPA   $1,U		; [video_address]
C969: 23 09          BLS    $C974
C96B: A1 C8 E1       CMPA   -$1F,U		; [video_address]
C96E: 23 04          BLS    $C974
...
C9A8: E6 4F          LDB    $F,U
C9AA: E7 0F          STB    $F,X
C9AC: B6 10 13       LDA    player_decoded_directions_1013
...
C9ED: 58             ASLB
C9EE: AE A5          LDX    B,Y
C9F0: 30 89 08 00    LEAX   $0800,X		; [video_address]
...
CA1D: 44             LSRA
CA1E: 25 0E          BCS    $CA2E
CA20: E6 89 F8 00    LDB    -$0800,X		; [video_address]
CA24: CB 50          ADDB   #$50
CA26: E7 89 F8 00    STB    -$0800,X		; [video_address]
CA2A: E6 A5          LDB    B,Y
CA2C: E7 84          STB    ,X				; [video_address]
CA2E: E6 C0          LDB    ,U+
CA30: 27 06          BEQ    $CA38
CA32: 3A             ABX
CA33: 20 E8          BRA    $CA1D
...
CABD: 33 C6          LEAU   A,U
CABF: E6 C9 08 00    LDB    $0800,U		; [video_address]
CAC3: C4 3F          ANDB   #$3F
CAC5: A6 C4          LDA    ,U		; [video_address]
CAC7: 2A 32          BPL    $CAFB
CAC9: C1 0F          CMPB   #$0F
CACB: 27 E7          BEQ    $CAB4
CACD: C1 10          CMPB   #$10
...
CAE1: 26 10          BNE    $CAF3
CAE3: C6 25          LDB    #$25
CAE5: E7 C9 08 00    STB    $0800,U				; [video_address]
CAE9: 20 C9          BRA    $CAB4
CAEB: C6 36          LDB    #$36
...
CB22: 81 6B          CMPA   #$6B
CB24: 26 31          BNE    $CB57
CB26: A6 C8 E0       LDA    -$20,U			; [video_address]
CB29: 2A 2C          BPL    $CB57
CB2B: 81 B8          CMPA   #$B8
CB2D: 27 28          BEQ    $CB57
CB2F: 81 85          CMPA   #$85
CB31: 27 24          BEQ    $CB57
CB33: 20 0D          BRA    $CB42
CB35: A6 C8 20       LDA    $20,U			; [video_address]
CB38: 2A 1D          BPL    $CB57
CB3A: 81 B0          CMPA   #$B0
CB3C: 27 19          BEQ    $CB57
CB3E: 81 8A          CMPA   #$8A
CB40: 27 15          BEQ    $CB57
CB42: CA 20          ORB    #$20
CB44: E7 C9 08 00    STB    $0800,U		; [video_address]
CB48: E6 C9 08 01    LDB    $0801,U		; [video_address]
CB4C: C4 0F          ANDB   #$0F
CB4E: CA 20          ORB    #$20
...
CCE6: A6 C8 20       LDA    $20,U		; [video_address]
CCE9: 81 70          CMPA   #$70
CCEB: 10 25 00 7B    LBCS   $CD6A
CCEF: A6 41          LDA    $1,U		; [video_address]
CCF1: 81 70          CMPA   #$70
CCF3: 10 25 00 73    LBCS   $CD6A
CCF7: A6 C8 21       LDA    $21,U		; [video_address]
CCFA: 81 70          CMPA   #$70
CCFC: 25 6C          BCS    $CD6A
CCFE: CC 44 06       LDD    #$4406
CD01: 20 33          BRA    $CD36
CD03: EA C9 08 01    ORB    $0801,U		; [video_address]
CD07: EA C9 08 21    ORB    $0821,U		; [video_address]
CD0B: EA C9 08 20    ORB    $0820,U		; [video_address]
CD0F: C4 80          ANDB   #$80
...
CDA8: 27 0F          BEQ    $CDB9
CDAA: A1 41          CMPA   $1,U	; [video_address]
CDAC: 10 22 00 96    LBHI   $CE46
CDB0: A1 C8 21       CMPA   $21,U	; [video_address]
CDB3: 10 22 00 8F    LBHI   $CE46
CDB7: 20 06          BRA    $CDBF
CDB9: E6 1A          LDB    -$6,X
CDBB: C1 0C          CMPB   #$0C
CDBD: 27 27          BEQ    $CDE6
CDBF: A1 C4          CMPA   ,U	; [video_address]
CDC1: 10 22 00 81    LBHI   $CE46
CDC5: A1 C8 20       CMPA   $20,U	; [video_address]
CDC8: 22 7C          BHI    $CE46
CDCA: 5F             CLRB
CDCB: A1 C8 E0       CMPA   -$20,U	; [video_address]
CDCE: 22 02          BHI    $CDD2
CDD0: CA 01          ORB    #$01
CDD2: A1 C8 40       CMPA   $40,U	; [video_address]
CDD5: 22 02          BHI    $CDD9
CDD7: CA 02          ORB    #$02
CDD9: C1 03          CMPB   #$03
CDDB: 27 42          BEQ    $CE1F
...
CDE4: 20 33          BRA    $CE19
CDE6: 5F             CLRB
CDE7: A6 C4          LDA    ,U	; [video_address]
CDE9: 81 70          CMPA   #$70
CDEB: 25 07          BCS    $CDF4
CDED: 84 F0          ANDA   #$F0
CDEF: 81 80          CMPA   #$80
CDF1: 27 01          BEQ    $CDF4
CDF3: 5C             INCB
CDF4: A6 C8 20       LDA    $20,U	; [video_address]
CDF7: 81 70          CMPA   #$70
CDF9: 25 08          BCS    $CE03
CDFB: 84 F0          ANDA   #$F0
CDFD: 81 80          CMPA   #$80
...
reset_e5ba:
E5BA: 7F 38 00       CLR    scroll_register_3800
...
E62B: 20 02          BRA    $E62F
E62D: 86 07          LDA    #$07
E62F: 7F 10 08       CLR    scroll_value_1008
...
E66A: C6 00          LDB    #$00
E66C: 1F 9B          TFR    B,DP
E66E: 7F 10 08       CLR    scroll_value_1008
E671: 4D             TSTA
E672: 26 06          BNE    $E67A
...
E8F2: B6 10 08       LDA    scroll_value_1008
E8F5: 81 F8          CMPA   #$F8
E8F7: 24 12          BCC    $E90B
E8F9: 7C 10 08       INC    scroll_value_1008
E8FC: 7C 10 08       INC    scroll_value_1008
...
E936: 2B 27          BMI    $E95F
E938: B6 10 08       LDA    scroll_value_1008
E93B: 10 27 FF 20    LBEQ   $E85F
E93F: 7A 10 08       DEC    scroll_value_1008
E942: 7A 10 08       DEC    scroll_value_1008
...
E98D: B6 10 08       LDA    scroll_value_1008
E990: 27 05          BEQ    $E997
...
EAAC: B6 48 16       LDA    dsw_extra_lives_select_level_4816
EAAF: 85 04          BITA   #$04		; select level enabled?
EAB1: 26 05          BNE    $EAB8
...
EAC4: B6 48 16       LDA    dsw_extra_lives_select_level_4816
EAC7: 84 03          ANDA   #$03
EAC9: E6 86          LDB    A,X
EACB: F7 01 78       STB    $0178
EACE: B6 48 16       LDA    dsw_extra_lives_select_level_4816
EAD1: 85 08          BITA   #$08
EAD3: 26 05          BNE    $EADA
...
EBB9: B6 10 08       LDA    scroll_value_1008
EBBC: 81 F8          CMPA   #$F8
EBBE: 26 1C          BNE    $EBDC
